        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" class="form-control form-control-solid w-250px ps-12 table-search" placeholder="Search Hour" />
                        </div>
                    </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="table" data-action="ticket_hours" data-delete="delete_hour">
                        <thead></thead>
                    </table>
                </div>
            </div>
...
jQuery(document).ready(function() {
    jQuery(document).on('click', '.<?=$modal_name?>', function(e) {
        e.preventDefault();
        showModal('Add Hour', '', 'Add Hour', 'add_hour');
    });
...
function localEdit(data) {
    ...
    showModal('Edit Hour', '', 'Update Hour', 'update_hour');
}
</script>
